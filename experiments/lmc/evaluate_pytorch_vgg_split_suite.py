"""Evaluate the full pytorch-vgg shared-split benchmark suite.

The runner loops over the standard split configurations and dispatches the
single-pair evaluator for every retained checkpoint pair found on disk.
"""
