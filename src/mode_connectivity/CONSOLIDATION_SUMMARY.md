...
**New way:**
```python
from mode_connectivity.core import checkpoint, data, models, output
from mode_connectivity.evaluation import evaluate as evaluation
```
...
**New way:**
```python
from mode_connectivity.core import setup, checkpoint
from mode_connectivity.evaluation import evaluate
