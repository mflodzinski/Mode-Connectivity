"""Helpers for constructing subprocess training commands.

These functions keep runner modules small by encapsulating the argument patterns
shared across the upstream curve and endpoint training scripts.
"""
