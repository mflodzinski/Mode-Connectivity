"""Small runtime-setup helpers shared by evaluation code.

The module currently handles device selection and backwards-compatible path
setup for the vendored ``dnn-mode-connectivity`` dependency.
"""
...
from mode_connectivity.external.dnn_mode_connectivity import add_to_path as add_dnn_mode_connectivity_to_path


def add_external_path():
    """Backward-compatible alias for the canonical external adapter."""

    return add_dnn_mode_connectivity_to_path()
