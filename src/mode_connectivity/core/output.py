"""File and artifact output helpers for experiment code.

This module centralizes JSON/NPZ/text writing helpers and convenience classes
for saving structured result bundles in a consistent layout.
"""
