"""Model-construction helpers for retained architecture families.

This module resolves architecture names from vendored upstream repos and builds
either standard endpoint models or curve-aware model variants.
"""
...
from mode_connectivity.external import load_curves_module, load_models_module
...
def create_curve_model(architecture: Any,
    ...
    Returns:
        CurveNet instance
    """
    external_curves = load_curves_module()
