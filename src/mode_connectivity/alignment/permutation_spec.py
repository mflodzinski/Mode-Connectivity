"""Permutation specifications for supported neural-network families.

The definitions in this file describe which parameter axes share a permutation,
which is the structural input required by the weight-matching routines.
"""
