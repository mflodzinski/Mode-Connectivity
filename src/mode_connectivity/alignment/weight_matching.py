"""Weight-matching routines for recovering hard neuron permutations.

The implementation is adapted to PyTorch from git-rebasin-style matching and is
used as the canonical discrete permutation baseline in the repository.
"""
