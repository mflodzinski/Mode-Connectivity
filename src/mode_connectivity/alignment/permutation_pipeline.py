"""Shared helpers for the retained VGG permutation-alignment pipeline.

The module bundles loading, permutation bookkeeping, comparison export, and
other reusable pieces that sit above the low-level alignment primitives.
"""
...
from mode_connectivity.core.checkpoint import load_checkpoint, load_state_dict
from mode_connectivity.core.output import ResultSaver, save_json
...
def state_dict_l2_distance(
    ...
    return float(state_distance_summary(state_a, state_b)["l2_distance"])
