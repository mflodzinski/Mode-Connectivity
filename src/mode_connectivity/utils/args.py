"""Reusable CLI argument-builder helpers.

The module keeps common parser fragments in one place so evaluation and plotting
scripts can share consistent flags without duplicating boilerplate.
"""
