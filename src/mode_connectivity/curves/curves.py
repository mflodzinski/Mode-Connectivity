"""Low-level helpers for working with saved curve checkpoints.

This module loads curve checkpoints, reconstructs bend parameters, and provides
small utilities for interpolating or summarizing curve states.
"""
...
from mode_connectivity.external import load_curves_module
