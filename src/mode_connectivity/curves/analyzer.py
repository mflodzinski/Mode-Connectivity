"""Analysis helpers for saved curve checkpoints.

The main class in this file loads curve states, extracts bend parameters, and
computes geometry or symmetry statistics used by downstream analyses.
"""
