"""Helpers for constructing mirrored network checkpoints.

The module applies deterministic reverse-order permutations and includes the
supporting logic needed to verify that the transformed network is equivalent.
"""
