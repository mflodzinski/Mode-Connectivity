"""Random permutation helpers for retained VGG-family experiments.

The module generates and applies full layer-wise permutations that preserve the
represented function and are used as controlled alignment test cases.
"""
