"""Helpers for applying function-preserving neuron or channel permutations.

These utilities manipulate compatible parameter axes while compensating the
adjacent layers so the transformed network computes the same function.
"""
