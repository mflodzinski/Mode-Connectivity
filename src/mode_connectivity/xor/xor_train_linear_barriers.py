"""Train XOR endpoints and measure linear interpolation barriers between them.

The module keeps the retained CLI implementation that trains multiple XOR
models, filters good endpoints, and exports pairwise linear-path diagnostics.
"""
...
from mode_connectivity.xor.xor_permutation_scale_experiment import clone_state_cpu, ensure_dir, parse_pairs, parse_seeds
