"""Model and path evaluation utilities.

This module combines endpoint evaluation helpers with the ``PathEvaluator``
class that measures loss and accuracy along interpolated model paths.
"""
