...
from scripts.lib.alignment.vgg16_sinkhorn_alignment import stable_sinkhorn
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default="configs/analysis/xor_sinkhorn_permutation_search.yaml",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="configs/analysis/xor_permutation_scale_search.yaml",
    )
    parser.add_argument(
        "--sinkhorn-perm-scale-search-config",
        type=str,
        default="configs/analysis/xor_sinkhorn_permutation_scale_search.yaml",
    )
