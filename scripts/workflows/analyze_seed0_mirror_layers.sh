...
# Paths
CURVE_CHECKPOINT="results/vgg16/cifar10/curve_seed0-mirror_noreg/checkpoints/checkpoint-200.pt"
ENDPOINT0="results/vgg16/cifar10/endpoints/checkpoints/seed0/checkpoint-200.pt"
ENDPOINT1="results/vgg16/cifar10/endpoints/checkpoints/seed0_mirrored/checkpoint-200.pt"
OUTPUT_DIR="results/vgg16/cifar10/curve_seed0-mirror_noreg/layer_analysis"
