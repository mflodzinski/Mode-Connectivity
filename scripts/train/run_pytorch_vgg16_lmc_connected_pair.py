"""Resume split training from an existing shared checkpoint using the pytorch-vgg-cifar10 recipe."""
...
from scripts.train.run_pytorch_vgg16_lmc_connected_pair_from_scratch import (
    build_loaders,
    build_model,
    load_checkpoint,
    nn,
