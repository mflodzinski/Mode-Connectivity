#!/usr/bin/env python3
"""Train polygon chain constrained to random plane."""
...
@hydra.main(
    version_base=None,
    config_path="../../configs/garipov/random_plane",
    config_name="vgg16_randomplane_midpoint_seed0-seed1",
)
def main(cfg: DictConfig):
    ...
    print("\n" + "="*80)
    print(f"RANDOM PLANE OPTIMIZATION ({anchor_type}, seed={cfg.random_plane_seed})")
    print("="*80)
    ...
    # Build command for random plane training
    ...
    print("\n" + "="*80)
    print("RANDOM PLANE OPTIMIZATION COMPLETE")
    print("="*80)
