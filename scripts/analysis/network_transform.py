"""Transform neural networks via mirroring, random permutation, or neuron swapping.
...
from lib.transform import mirror, neuron_swap, random_permutation
...
def main():
    parser = argparse.ArgumentParser(
        description='Transform neural networks via mirroring, random permutation, or neuron swapping'
    )

    # Custom arguments specific to this script
    parser.add_argument('--mode', required=True, choices=['mirror', 'random', 'swap'],
