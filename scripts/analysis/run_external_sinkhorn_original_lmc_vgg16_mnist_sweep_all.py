"""Run a focused sweep for the original external Sinkhorn LMC MNIST wrapper."""
...
def run_original_sinkhorn_lmc_sweep_all(cfg: DictConfig) -> None:
    """Run the configured original-LMC sweep sequentially."""
    ...
    print("=" * 80)
    print("ORIGINAL EXTERNAL SINKHORN LMC FULL SWEEP")
    print("=" * 80)
    ...
    for task_id in range(start_index, end_index + 1):
        ...
        try:
            metadata = run_original_sinkhorn_lmc_vgg16_mnist(run_cfg)
    ...
    print("")
    print("=" * 80)
    print("ORIGINAL EXTERNAL SINKHORN LMC FULL SWEEP COMPLETE")
    print("=" * 80)
...
@hydra.main(
    ...
    config_name="external_sinkhorn_original_lmc_vgg16_mnist_sweep",
)
