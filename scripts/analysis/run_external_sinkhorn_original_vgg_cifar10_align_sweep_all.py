"""Sweep original sinkhorn re-basin alignment params for saved non-BN VGG CIFAR10 endpoints."""
...
def run_one_alignment(
    ...
    *,
    ...
    print("")
    print("=" * 80)
    print(f"ORIGINAL SINKHORN {vgg_name} {dataset_name} ALIGNMENT")
    print("=" * 80)
...
def run_alignment_sweep_all(cfg: DictConfig) -> None:
    ...
    print("=" * 80)
    print(f"ORIGINAL SINKHORN {cfg.vgg_name} CIFAR10 ALIGNMENT SWEEP")
    print("=" * 80)
