...
#SBATCH --output=slurm_external_sinkhorn_orig_vgg11_mnist_endpoint_eval_%j.out
#SBATCH --error=slurm_external_sinkhorn_orig_vgg11_mnist_endpoint_eval_%j.err
#SBATCH --job-name=ext_sh_v11_eval
...
OUTPUT_ROOT="${OUTPUT_ROOT:-results/vgg11/mnist/original_sinkhorn_lmc_endpoint_eval}"
MODEL_A_CHECKPOINT="${MODEL_A_CHECKPOINT:-results/vgg11/mnist/original_sinkhorn_lmc/model_a.pt}"
MODEL_B_CHECKPOINT="${MODEL_B_CHECKPOINT:-results/vgg11/mnist/original_sinkhorn_lmc/model_b.pt}"
VGG_NAME="${VGG_NAME:-VGG11}"
BATCH_SIZE="${BATCH_SIZE:-128}"

echo "========================================"
echo "Original Sinkhorn VGG11 MNIST Endpoint Eval"
echo "========================================"
...
srun python scripts/analysis/run_external_sinkhorn_original_vgg11_mnist_endpoint_eval.py \
...
echo ""
echo "========================================"
echo "ORIGINAL SINKHORN ${VGG_NAME} MNIST ENDPOINT EVAL COMPLETE"
echo "========================================"
