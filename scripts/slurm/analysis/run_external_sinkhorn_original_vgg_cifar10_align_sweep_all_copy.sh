...
#SBATCH --output=slurm_external_sinkhorn_orig_vgg_cifar10_align_sweep_copy_%j.out
#SBATCH --error=slurm_external_sinkhorn_orig_vgg_cifar10_align_sweep_copy_%j.err
#SBATCH --job-name=ext_sh_vg_cf2
...
echo "========================================"
echo "Original Sinkhorn VGG CIFAR10 Align Sweep (copy config)"
echo "========================================"
...
echo ""
echo "========================================"
echo "ORIGINAL SINKHORN VGG CIFAR10 ALIGN SWEEP COMPLETE"
echo "========================================"
