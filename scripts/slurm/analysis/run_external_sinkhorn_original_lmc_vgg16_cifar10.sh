...
#SBATCH --output=slurm_external_sinkhorn_orig_lmc_cifar10_%j.out
#SBATCH --error=slurm_external_sinkhorn_orig_lmc_cifar10_%j.err
#SBATCH --job-name=ext_sh_lmc_c10
...
OUTPUT_ROOT="${OUTPUT_ROOT:-results/vgg16/cifar10/alignment/external_sinkhorn_original_lmc/seed0-seed1}"
DATA_PATH="${DATA_PATH:-./data}"
ALIGNMENT_EPOCHS="${ALIGNMENT_EPOCHS:-300}"
ALIGNMENT_BATCH_SIZE="${ALIGNMENT_BATCH_SIZE:-128}"
CALIBRATION_SIZE="${CALIBRATION_SIZE:-5000}"
...
echo "========================================"
echo "Original External Sinkhorn LMC (CIFAR10)"
echo "========================================"
...
srun python scripts/analysis/run_external_sinkhorn_original_lmc_vgg16_cifar10.py \
...
echo ""
echo "========================================"
echo "ORIGINAL EXTERNAL SINKHORN LMC CIFAR10 RUN COMPLETE"
echo "========================================"
