...
#SBATCH --output=slurm_external_pytorch_vgg_cifar10_vgg11_2seeds_%j.out
#SBATCH --error=slurm_external_pytorch_vgg_cifar10_vgg11_2seeds_%j.err
#SBATCH --job-name=ext_vgg11_2s
...
echo "========================================"
echo "External pytorch-vgg-cifar10 VGG11 x2"
echo "========================================"
