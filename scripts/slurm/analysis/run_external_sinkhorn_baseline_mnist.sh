...
#SBATCH --output=slurm_external_sinkhorn_mnist_%j.out
#SBATCH --error=slurm_external_sinkhorn_mnist_%j.err
#SBATCH --job-name=ext_sinkhorn_mnist
...
echo "========================================"
echo "External Sinkhorn-Rebasin Baseline (MNIST)"
echo "========================================"
...
srun python scripts/analysis/run_external_sinkhorn_baseline_mnist.py \
...
echo ""
echo "========================================"
echo "EXTERNAL SINKHORN MNIST RUN COMPLETE"
echo "========================================"
