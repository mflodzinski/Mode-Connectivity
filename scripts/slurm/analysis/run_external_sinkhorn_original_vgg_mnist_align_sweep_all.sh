...
#SBATCH --output=slurm_external_sinkhorn_orig_vgg_mnist_align_sweep_%j.out
#SBATCH --error=slurm_external_sinkhorn_orig_vgg_mnist_align_sweep_%j.err
#SBATCH --job-name=ext_sh_vg_mn
...
echo "========================================"
echo "Original Sinkhorn VGG MNIST Align Sweep"
echo "========================================"
...
srun python scripts/analysis/run_external_sinkhorn_original_vgg_mnist_align_sweep_all.py "${args[@]}"

echo ""
echo "========================================"
echo "ORIGINAL SINKHORN VGG MNIST ALIGN SWEEP COMPLETE"
echo "========================================"
