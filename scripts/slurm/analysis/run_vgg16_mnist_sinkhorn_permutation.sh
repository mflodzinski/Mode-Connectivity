...
#SBATCH --output=slurm_vgg16_mnist_sinkhorn_perm_%j.out
#SBATCH --error=slurm_vgg16_mnist_sinkhorn_perm_%j.err
#SBATCH --job-name=vgg16_mnist_perm
...
OUTPUT_ROOT="${OUTPUT_ROOT:-results/vgg16/mnist/alignment/sinkhorn_permutation/seed0-seed1}"
...
echo "========================================"
echo "VGG16/MNIST Sinkhorn Permutation"
echo "========================================"
...
srun python scripts/analysis/run_vgg16_mnist_sinkhorn_permutation.py \
...
echo ""
echo "========================================"
echo "VGG16/MNIST PERMUTATION PIPELINE COMPLETE"
echo "========================================"
