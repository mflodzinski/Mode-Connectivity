...
#SBATCH --output=slurm_external_sinkhorn_orig_lmc_mnist_sweep_all_%j.out
#SBATCH --error=slurm_external_sinkhorn_orig_lmc_mnist_sweep_all_%j.err
#SBATCH --job-name=ext_lmc_mn_sw
...
echo "========================================"
echo "Original External Sinkhorn LMC Full Sweep"
echo "========================================"
...
srun python scripts/analysis/run_external_sinkhorn_original_lmc_vgg16_mnist_sweep_all.py \
...
echo ""
echo "========================================"
echo "ORIGINAL EXTERNAL SINKHORN LMC MNIST FULL SWEEP COMPLETE"
echo "========================================"
echo "Results are written under the sweep base output root configured in:"
echo "  configs/analysis/external_sinkhorn_original_lmc_vgg16_mnist_sweep.yaml"
