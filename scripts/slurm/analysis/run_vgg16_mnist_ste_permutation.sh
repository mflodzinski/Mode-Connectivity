...
#SBATCH --output=slurm_vgg16_mnist_ste_perm_%j.out
#SBATCH --error=slurm_vgg16_mnist_ste_perm_%j.err
#SBATCH --job-name=vgg16_mnist_ste
...
OUTPUT_ROOT="${OUTPUT_ROOT:-results/vgg16/mnist/alignment/ste_permutation/seed0-seed1}"
...
echo "========================================"
echo "VGG16 MNIST STE Permutation"
echo "========================================"
...
srun python scripts/analysis/run_vgg16_mnist_ste_permutation.py \
...
echo ""
echo "========================================"
echo "VGG16 MNIST STE RUN COMPLETE"
echo "========================================"
